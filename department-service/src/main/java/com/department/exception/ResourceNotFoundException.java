...
public class ResourceNotFoundException extends RuntimeException{
	...
	public ResourceNotFoundException(String resourceName, String feildName, String departmentCode) {
		super(String.format("%s not found with %s : %s", resourceName,feildName,departmentCode));
		this.resourceName = resourceName;
		this.feildName = feildName;
		this.feildValue = feildValue;
	}
